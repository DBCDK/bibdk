  ...
  stages {
    ...
    stage('Docker: Drupal database') {
      ...
      steps {
        dir('docker/db') {
          sh """
            wget -P docker-entrypoint.d https://is.dbc.dk/view/Bibliotek.dk/job/dscrum-is-bibdk_dump_prod_db/lastSuccessfulBuild/artifact/bibdk_db.tar -o - | tar -xf bibdk_db.tar
          """
          script {
