...
<div class="element-section visuallyhidden">
  <div class="library-details text clearfix">
    <div class="library-details-column-1">
      <p class="subheader">
        <strong><?php print t('bibdk_favourite_address'); ?></strong></p>

      <p><?php print $address; ?></p>

      <p class="subheader">
        <strong><?php print t('bibdk_favourite_contact'); ?></strong></p>
    ...
    <div class="library-details-column-2">
      ...
      <?php if ($tools) { ?>
        <p class="subheader">
          <strong><?php print t('bibdk_favourite_tools'); ?></strong></p>
        <?php print $tools; ?>
      <?php } ?>
    </div>
  </div>
