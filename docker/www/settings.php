...
/* pjo added this to fix bounce between http and https on autocomplete */
# $conf['https']='@SECURE_CONF@';
...
# $base_url = "@BASE_PROTOCOL@".$_SERVER['HTTP_HOST'];
...
// pjo these are wrong for k8s - use dmz proxy
 ...
 */
# $conf['reverse_proxy_addresses'] = array('192.168.42.1', '192.168.40.1', '172.18.1.28');
/**
