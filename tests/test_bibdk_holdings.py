...
class BibdkHoldingsTestCase(helpers.BibdkUnitTestCase):
    def test_holdnings_manifestation_link(self):
        ...
        browser.find_element_by_id("selid-870970basis51229312").click()

        bibdk_holdings_favourites_link = browser.find_element_by_class_name("bibdk-holdings-favourites")
        ...
        bibdk_holdings_favourites_link.find_element_by_class_name("icon-left")
