...
class TestWorktabs(helpers.BibdkUnitTestCase):
    ...
    def load_worktab(self, get_tab):
        ...
        search = browser.find_element_by_id('edit-search-block-form--2')
        search.send_keys('rec.id=' + self.rec_id())
        browser.find_element_by_id('edit-submit').click()
        browser.find_element_by_id(self.work_href()).click()
        ...
        browser.find_element_by_css_selector('a[href="' + get_tab() + '"]').click()
    ...
    def load_reviews(self, count):
        ...
        for no in no_contents:
            ancestor = no.find_element_by_xpath('../../..')
