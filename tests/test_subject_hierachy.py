...
class TestBibdkSubjectHierachy(helpers.BibdkUnitTestCase):
    ...
    def test_direct_links(self):
        ...
        subject_hierarchy.find_element(By.ID, "subject-hierarchy-note-link-0-6").click()

        subject_hierarchy.find_element(By.CLASS_NAME, "row-2")
        ...
        subject_hierarchy.find_element(By.CLASS_NAME, "subjects-sublists")

        subject_hierarchy.find_element(By.ID, "subject-hierarchy-label-link-0-1").click()
        WebDriverWait(browser, 20).until(expected_conditions.presence_of_element_located((By.LINK_TEXT, "Sygdomme")))

        row_1 = subject_hierarchy.find_element(By.CLASS_NAME, "row-1")
        row_1.find_element(By.CLASS_NAME, "subjects-sublists")

        browser.find_element(By.ID, "subject-hierarchy-label-link-0-11").click()
        WebDriverWait(browser, 20).until(expected_conditions.presence_of_element_located((By.LINK_TEXT, "Erindringer og biografier")))

        row_3 = browser.find_element(By.CLASS_NAME, "row-1")
        row_3.find_element(By.CLASS_NAME, "subjects-sublist")
    ...
    def test_subject_hierachy_breadcrumb(self):
        ...
        # browser.find_element(By.ID, "subject-hierarchy-label-link-0-4").click()
        self._check_pop_up()
        link_element = browser.find_element(By.XPATH, "//a[contains(@href,'" + link_a + "')]")
        ...
        #browser.find_element(By.XPATH, "//a[contains(@href,'" + link_a + "')]").click()
        ...
        breadcrumb.find_element(By.XPATH, "//a[contains(@href,'" + link_b + "')]").click()
        ...
        self.assertTrue(index != -1, "Found link")

        # click the first item in the nwely opened subjectbrowser
        breadcrumb.find_element(By.XPATH, "//a[contains(@href,'" + link_c + "')]").click()
        ...
        # verify heading
        heading = browser.find_element(By.CLASS_NAME, "subjects-sublists-heading")
        self.assertTrue(heading != -1, "Found heading element")

        # self.assertTrue(div_tag.text equals heading.text, "heading element text equals breadcrumb text")
        div_tag = breadcrumb.find_element(By.CLASS_NAME, 'container-last')
    ...
    def test_subject_hierarchy_search(self):
        ...
        # ensure that the subject hierachy is present
        subject_hierachy_searchfield = browser.find_element(By.CLASS_NAME, "subject-hierarchy-searchfield")
        subject_hierachy_link_wrapper = subject_hierachy_searchfield.find_element(By.CLASS_NAME, "show-for-large-up")
        # move to subject hierarchy - it might not be visible
        actions = ActionChains(browser)
        ...
        subject_hierachy_searchresult = browser.find_element(By.ID, "bibdk-subject-hierarchy-searchresult")
        ...
        subject_hierachy_submit = browser.find_element(By.ID, "edit-search-hierarchy-submit")
        ...
        hierarchy_searchresult = browser.find_element(By.ID, "bibdk-subject-hierarchy-searchresult")
        self.assertTrue(hierarchy_searchresult.is_displayed(), "subject hierachy search result should be visible")

        hierarchy_searchresult_header = hierarchy_searchresult.find_element(By.CLASS_NAME, "header")
        self.assertTrue(hierarchy_searchresult_header.is_displayed(), "hierarchy searchresult header should be visible")

        hierarchy_searchresult_subjects_breadcrumb = hierarchy_searchresult.find_element(By.CLASS_NAME, "subjects-breadcrumb")
        ...
        hierarchy_searchresult_item_list = hierarchy_searchresult.find_element(By.CLASS_NAME, "item-list")
    ...
    def test_subject_hierarchy_responsive(self):
        ...
        # ensure that the subject hierachy is present
        subject_hierachy = browser.find_element(By.ID, "subjectshierarchy")
        # move to subject hierarchy - it might not be visible
        actions = ActionChains(browser)
        ...
        # click the 6th element in the subject hierachy
        subject_hierachy.find_element(By.ID, "subject-hierarchy-note-link-0-6").click()
        WebDriverWait(browser, 30).until(expected_conditions.presence_of_element_located((By.CLASS_NAME, "subjects-sublists")))

        subject_hierachy.find_element(By.CLASS_NAME, "subject-item")
        subject_hierachy.find_element(By.CLASS_NAME, "subjects-sublist")

        searchfield = subject_hierachy.find_element(By.CLASS_NAME, "subject-hierarchy-searchfield")
        show_for_large_up = searchfield.find_element(By.CLASS_NAME, "show-for-large-up")
        self.assertTrue(show_for_large_up.is_displayed(), "searchfield.show-for-large-up should be visible")

        hide_for_large_up = searchfield.find_element(By.CLASS_NAME, "hide-for-large-up")
        ...
        time.sleep(10)
        visible = subject_hierachy.find_element(By.ID, "bibdk-subject-hierarchy")
        ...
        not_visible = subject_hierachy.find_element(By.ID, "bibdk-subject-hierarchy")
