...
class TestInfomediaLink(helpers.BibdkUnitTestCase):
    ...
    def test_link_present_short_view(self):
        ...
        self.browser.find_element_by_id('selid-870971avis89724244').click()
    ...
    def test_infomedia_view_article(self):
        ...
        # Show article
        browser.find_element_by_xpath('//div[@class="infomedia_HeadLine"]')
    ...
    def test_infomedia_login_link(self):
        ...
        login_link = browser.find_element_by_id('infomedia_toggle_link')
        login_link.click()

        browser.find_element_by_xpath('//form[@id="user-login"]')
    ...
    def login_with_modal(self, username, password):
        ...
        # input username
        user = modal.find_element_by_id("edit-name")
        user.clear()
        user.send_keys(username)

        # insert password
        passw = modal.find_element_by_id("edit-pass")
        passw.clear()
        passw.send_keys(password)

        # get submit button
        modal.find_element_by_id("edit-submit").click()
