...
class TestSBKopi(helpers.BibdkUnitTestCase):
    def test_bestil_gratis_e_kopi_link(self):
        ...
        browser.find_element(BY.ID, "870971-tsart34276501")

    def test_bestil_kopi_on_single_work(self):
        browser = self.browser
        single_work_pid = "work/870971-tsart:35977937"
        browser.get(self.base_url + single_work_pid)
        manifestation = browser.find_element(BY.ID, "870971-tsart35977937")
    ...
    def test_sbkopi_popup_window(self):
        ...
        self._check_pop_up()
        self.browser.find_element(BY.ID, 'selid-870971tsart35977937').click()
        browser.implicitly_wait(20)
        browser.find_element(BY.XPATH, "//a[contains(@href,'reservation/sbkopi/870971-tsart%3A35977937')]").click()
