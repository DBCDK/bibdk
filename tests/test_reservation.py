...
class TestReservation(helpers.BibdkUnitTestCase):
    ...
    def test_redirect_after_order_complete_redirect_to_bibdk_userstatus(self):
        ...
        ##browser.find_element_by_xpath("//input[@id='edit-3' and not(@disabled)]")
        ##browser.find_element_by_id("edit-next").click()
    ...
    def test_redirect_after_order_complete_redirect_to_local_userstatus_page(self):
        ...
        browser.find_element_by_id('edit-userid').send_keys('fisk')
        browser.find_element_by_id('edit-pincode').send_keys('123456')
        # click the next button
        reserve_but = browser.find_element_by_id("edit-next")
        ...
        # ensure a link is present
        #link = messages.find_element_by_xpath("//a[contains(@href, 'http://www.danbib.dk/vip_lånerstatus')]")
