...
class TestAgencySearch(helpers.BibdkUnitTestCase):
    ...
    def test_search_agency(self):
        ...
        self.assertTrue(len(browser.find_elements_by_css_selector(".ting-agency-library")) > 10)

        # assert frederiksberg hovedbibliotek is present
        browser.find_element_by_css_selector('.ting-agency-library.favourite-714700')

        # assert more info
        browser.find_element_by_css_selector('.ting-agency-library.favourite-714700').click()
