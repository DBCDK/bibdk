...
projects[bibdk_theme][download][tag] = 7.x-0.4
...
projects[ding_entity][download][tag] = 7.x-0.7+dbc.2
...
projects[ting_agency][download][tag] = 7.x-0.3
...
projects[ting_openformat][download][tag] = 7.x-0.4
...
projects[bibdk_favourite][download][tag] = 7.x-0.4
...
projects[bibdk_frontend][download][tag] = 7.x-0.4
...
projects[bibdk_provider][download][tag] = 7.x-0.4
...
projects[bibdk_reservation][download][tag] = 7.x-0.4
...
projects[bibdk_vejviser][download][tag] = 7.x-0.3
