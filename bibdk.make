...
projects[ding_user][download][tag] = 7.x-0.19-dbc.21
...
projects[ding_wayf][download][tag] = 7.x-0.6+dbc.13
...
projects[ting-client][download][tag] = 7.x-2.43
...
projects[bibdk_config][download][tag] = 7.x-0.35
